...
export default function NewActivity({ selectedStudent }) {
  ...
  function handleSave() {
    ...
    const sortedActivities = currentStudent.activities.sort(
      (a, b) => a.id - b.id
    );
    ...
    const data = {
      ...
      id:
        sortedActivities.length > 0
          ? parseInt(sortedActivities[sortedActivities.length - 1].id) + 1
          : 1,
      ...
      {show && (
        ...
        >
          <Modal.Header closeButton>
            <Modal.Title>Ny aktivetet</Modal.Title>
          </Modal.Header>
          <Modal.Body>
            ...
            >
              ...
              {selectedActivity !== "0" ? (
                <Row className="my-3">
                  ...
                  <p className="mb-0 px-4 text-muted">
                    {
                      activities.find(
